# diff
Vibecoded python utility to perform intelligent diff (lineshifts are not flagged) between two text files with elegant output. Context window is parameterized.
